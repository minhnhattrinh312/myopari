...
%
\begin{abstract}
% Cardiac magnetic resonance (CMR) is the reference standard for assessing cardiac function and viability, yet its clinical adoption remains limited in many resource-constrained settings due to the shortage of specialized staff and the high computational requirements of existing AI-based solutions. Here, we introduce \textit{Myopari}, an open-source Napari plugin for automated quantitative CMR analysis designed to operate on low-cost, energy-efficient edge devices. The framework integrates a lightweight FC-DenseNet segmentation model with automated cardiac biomarker extraction, three-dimensional visualization, and structured patient report generation within an intuitive graphical user interface (GUI). The proposed model contains only 1.4 million parameters ($\sim$5 MB) while maintaining robust segmentation performance on the ACDC and EMIDEC benchmark CMR datasets. Deployment was evaluated on NVIDIA Jetson Orin Nano and Raspberry Pi 5, achieving inference times of approximately 2.2 s and 10.6 s per patient, respectively, with no statistically significant differences in segmentation performance compared with a high-performance GPU workstation ($p>0.05$). The software enables fully automated analysis through a single-click workflow, eliminating the need for a dedicated GPU workstation or programming expertise. Moreover, the modular design allows \textit{Myopari} to be extended to other CMR sequences and imaging modalities. Thus, by combining accurate AI-assisted CMR analysis with affordable hardware and user-friendly software, \textit{Myopari} provides a practical and sustainable solution for expanding access to advanced cardiac imaging analysis in low- and middle-income countries and other resource-constrained healthcare settings. \textit{Myopari} software and source code are publicly available at \href{https://anonymous.4open.science/r/myopari-4AA7}{anonymous.4open.science/r/myopari-4AA7}.

Cardiac magnetic resonance (CMR) is the reference standard for assessing cardiac function and viability, yet its clinical adoption remains limited in many resource-constrained settings due to shortages of specialized staff and the computational requirements of existing AI solutions. Here, we introduce \textit{Myopari}, an open-source Napari plugin for automated quantitative CMR analysis on low-cost, energy-efficient edge devices. The framework integrates a lightweight FC-DenseNet segmentation model with automated biomarker extraction, three-dimensional visualization, and structured patient report generation within an intuitive graphical user interface. The proposed model contains only 1.4 million parameters ($\sim$5 MB) while maintaining robust segmentation performance on the ACDC and EMIDEC datasets. Deployment on the NVIDIA Jetson Orin Nano and Raspberry Pi 5 achieved inference times of approximately 2.2 s and 10.6 s per patient, respectively, with no statistically significant differences in segmentation performance compared with a GPU workstation ($p>0.05$). \textit{Myopari} enables fully automated analysis through a single-click workflow without requiring dedicated GPU hardware or programming expertise. By combining accurate AI-assisted CMR analysis with affordable hardware and user-friendly software, \textit{Myopari} provides a practical and sustainable solution for expanding access to advanced cardiac imaging in low- and middle-income countries and other resource-constrained healthcare settings. The software and source code are publicly available at \href{https://anonymous.4open.science/r/myopari-4AA7}{anonymous.4open.science/r/myopari-4AA7}. 
...
Training was performed on an NVIDIA GeForce RTX 4070 SUPER GPU (12 GB) using mixed-precision (FP16/FP32) computation. Images were cropped and resized to $256 \times 256$ pixels before training. The network was optimized with the NAdam optimizer \cite{nadam} (learning rate $10^{-3}$) for approximately 500 epochs, requiring about 5 hours. To improve segmentation under class imbalance and enhance boundary delineation, the Focal Active Contour Loss \cite{focal_active_loss}, combining focal weighting with active contour regularization, was employed. After training, the model was converted to an optimized inference format and post-training quantized for deployment on low-cost edge devices, including the NVIDIA Jetson Orin Nano Developer Kit and Raspberry Pi 5. Model performance was evaluated on ACDC and EMIDEC by comparing the predicted segmentations with the reference annotations using the Dice similarity coefficient (Dice), Hausdorff distance (HD), and volume difference. For EMIDEC, scar burden (\% infarcted myocardium) was also assessed.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.8\linewidth]{images/myopari.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{images/segmentation_metrics.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{images/reports.pdf}
...
% This study was supported by the ``la Caixa'' Foundation and FCT, I.P. under project LCF/PR/HR22/00533; by national funds from FCT -- Foundation for Science and Technology, I.P. through contracts UID/04326/2025, UID/PRR/04326/2025, and LA/P/0101/2020; by the NVIDIA GPU Hardware Grant; by the European Union's Horizon Europe Programme IMAGINE under Grant Agreement No.~101094250 (topic HORIZON-INFRA-2022-TECH-01-01); and by FCT -- Foundation for Science and Technology, I.P. through project 2025.02647.BDANA (DOI: \url{https://doi.org/10.54499/2025.02647.BDANA}).
% This study received funding from FCT – Portuguese Foundation for Science and Technology through contracts UID/04326/2025, UID/PRR/04326/2025 and LA/P/0101/2020 (DOI:10.54499/LA/P/0101/2020), 2025.02647.BDANA (DOI: 10.54499/2025.02647.BDANA), ‘la Caixa’ Foundation and FCT, I.P. under the project code [LCF/PR/HR22/00533], NVIDIA GPU hardware grant, EU’s Horizon Europe (IMAGINE with GA\#101094250)
