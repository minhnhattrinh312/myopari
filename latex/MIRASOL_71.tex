...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{images/myopari.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.95\linewidth]{images/samples.pdf}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{images/segmentation_metrics.pdf}
